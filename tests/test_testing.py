...
def test_are_dfs_equal_false_schema(spark, input_left):
    """Test that calling are_dfs_equal on DataFrames with different schemas
    returns false"""
...
def test_are_dfs_equal_false_collect(spark, input_left):
    """Test that calling are_dfs_equal on dataframes with different data values
    returns false"""
...
def test_are_dfs_equal_false_type(spark, input_left):
    """Test that calling are_dfs_equal on dataframes with identical data values
    but different data types returns false"""
